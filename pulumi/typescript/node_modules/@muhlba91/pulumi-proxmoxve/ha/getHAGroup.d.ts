 ...
 * ```
 */
export declare function getHAGroup(args: GetHAGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetHAGroupResult>;
/**
 ...
 * ```
 */
export declare function getHAGroupOutput(args: GetHAGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetHAGroupResult>;
/**
 * A collection of arguments for invoking getHAGroup.
 */
