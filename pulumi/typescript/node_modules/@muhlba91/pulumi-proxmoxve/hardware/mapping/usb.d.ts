 ...
 * ```
 */
export declare class Usb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsbState, opts?: pulumi.CustomResourceOptions): Usb;
    /**
     * Returns true if the given object is an instance of Usb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Usb;
    /**
     ...
     */
    readonly maps: pulumi.Output<outputs.Hardware.mapping.UsbMap[]>;
    /**
