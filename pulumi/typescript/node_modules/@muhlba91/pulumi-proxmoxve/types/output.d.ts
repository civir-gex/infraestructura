...
export declare namespace CT {
    ...
    interface ContainerInitializationDns {
        /**
    ...
    interface ContainerInitializationIpConfig {
        /**
    ...
    interface ContainerInitializationIpConfigIpv4 {
        /**
    ...
    interface ContainerInitializationIpConfigIpv6 {
        /**
    ...
    interface ContainerInitializationUserAccount {
        /**
    ...
    interface ContainerOperatingSystem {
        /**
...
export declare namespace Network {
    ...
    interface FirewallLogRatelimit {
        /**
    ...
    interface FirewallSecurityGroupRule {
        /**
         * Rule action (`ACCEPT`, `DROP`, `REJECT`).
         */
        action?: string;
...
export declare namespace VM {
    interface GetVirtualMachinesFilter {
        /**
    ...
    interface GetVirtualMachinesVm {
        /**
    ...
    interface VirtualMachine2Cdrom {
        /**
         * The file ID of the CD-ROM, or `cdrom|none`. Defaults to `none` to leave the CD-ROM empty. Use `cdrom` to connect to the physical drive.
         */
        fileId: string;
    }
    interface VirtualMachine2Clone {
        /**
         * The ID of the VM to clone.
         */
        id: number;
    ...
    interface VirtualMachine2Timeouts {
        /**
         * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
         */
        create?: string;
    ...
    interface VirtualMachineAudioDevice {
        /**
    ...
    interface VirtualMachineDiskSpeed {
        /**
    ...
    interface VirtualMachineEfiDisk {
        /**
         * The identifier for the datastore to create
         * the disk in (defaults to `local-lvm`).
         */
    ...
    interface VirtualMachineHostpci {
        /**
    ...
    interface VirtualMachineInitialization {
        /**
         * The identifier for the datastore to create the
    ...
    interface VirtualMachineInitializationDns {
        /**
         * The DNS search domain.
         */
        domain?: string;
    ...
    interface VirtualMachineInitializationIpConfig {
        /**
         * The IPv4 configuration.
         */
    ...
    interface VirtualMachineInitializationIpConfigIpv4 {
        /**
    ...
    interface VirtualMachineInitializationIpConfigIpv6 {
        /**
    ...
    interface VirtualMachineInitializationUserAccount {
        /**
         * The SSH keys.
         */
        keys?: string[];
    ...
    interface VirtualMachineMemory {
        /**
         * The dedicated memory in megabytes (defaults
         * to `512`).
         */
    ...
    interface VirtualMachineNetworkDevice {
        /**
    ...
    interface VirtualMachineOperatingSystem {
        /**
         * The type (defaults to `other`).
         */
        type?: string;
    }
    interface VirtualMachineSerialDevice {
        /**
    ...
    interface VirtualMachineSmbios {
        /**
         * The family string.
         */
        family?: string;
    ...
    interface VirtualMachineStartup {
        /**
         * A non-negative number defining the delay in
    ...
    interface VirtualMachineTpmState {
        /**
         * The identifier for the datastore to create
         * the disk in (defaults to `local-lvm`).
         */
